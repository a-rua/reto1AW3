...
public class update_historico {
	...
	public update_historico(int identificador_accion, String tabla_afectada, String fecha, int datos_anteriores) {
		super();
	...
	public String toString() {
		return "update_historico [identificador_accion=" + identificador_accion + ", tabla_afectada=" + tabla_afectada
